...
export function Contact() {
  ...
  return (
    <section id="contact" className="scroll-mt-28 pt-16 pb-20 md:pt-20">
      ...
      <div className="font-mono mt-10 flex items-center justify-center gap-2 text-center text-xs text-[var(--text-dim)]">
        <Image src={logoMark} alt="" className="h-5 w-5 rounded-[0.4rem] ring-1 ring-[var(--border)]" />
